...
merged = geopandas.sjoin(gdw, cell, how='left', op='within')
dissolve = merged.dissolve(by="index_right", aggfunc="sum")
cell.loc[dissolve.index,'TOT_64_']= dissolve.TOT_64_.values
...
merged = geopandas.sjoin(gdw, cell, how='left', op='within')
dissolve = merged.dissolve(by="index_right", aggfunc="sum")
cell.loc[dissolve.index,'TOT_MALE_O_14']= dissolve.TOT_MALE_0_14.values
...
merged = geopandas.sjoin(gdw, cell, how='left', op='within')
dissolve = merged.dissolve(by="index_right", aggfunc="sum")
cell.loc[dissolve.index,'TOT_MALE_64_']= dissolve.TOT_MALE_64_.values
...
merged = geopandas.sjoin(gdw, cell, how='left', op='within')
dissolve = merged.dissolve(by="index_right", aggfunc="sum")
cell.loc[dissolve.index,'TOT_FEMALE_O_14']= dissolve.TOT_FEMALE_0_14.values
...
merged = geopandas.sjoin(gdw, cell, how='left', op='within')
dissolve = merged.dissolve(by="index_right", aggfunc="sum")
cell.loc[dissolve.index,'TOT_FEMALE_15_64']= dissolve.TOT_FEMALE_15_64.values
...
merged = geopandas.sjoin(gdw, cell, how='left', op='within')
dissolve = merged.dissolve(by="index_right", aggfunc="sum")
cell.loc[dissolve.index,'TOT_FEMALE_64_']= dissolve.TOT_FEMALE_64_.values
